...
namespace GridViewSaveChangesExample {
    ...
    public partial class nwindDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public ProductsRow AddProductsRow(string ProductName, decimal UnitPrice, short UnitsInStock, short UnitsOnOrder, bool Discontinued) {
...
namespace GridViewSaveChangesExample.nwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)) AND ((? = 1 AND `Discontinued` IS NULL) OR (`Discontinued` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`ProductName`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder" +
                "`, `Discontinued`) VALUES (?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `ProductName` = ?, `UnitPrice` = ?, `UnitsInStock` = ?, `UnitsOnOrder` = ?, `Discontinued` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)) AND ((? = 1 AND `Discontinued` IS NULL) OR (`Discontinued` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GridViewSaveChangesExample.Properties.Settings.Default.nwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, UnitPrice, UnitsInStock, UnitsOnOrder, Discontinue" +
                "d FROM Products";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock, global::System.Nullable<short> Original_UnitsOnOrder, bool Original_Discontinued) {
            ...
            if ((Original_UnitsInStock.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((short)(Original_UnitsInStock.Value));
            }
            else {
            ...
            if ((Original_UnitsOnOrder.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((short)(Original_UnitsOnOrder.Value));
            }
            else {
            ...
            this.Adapter.DeleteCommand.Parameters[10].Value = ((bool)(Original_Discontinued));
        ...
        public virtual int Insert(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, global::System.Nullable<short> UnitsOnOrder, bool Discontinued) {
            if ((ProductName == null)) {
            ...
            if ((UnitsOnOrder.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((short)(UnitsOnOrder.Value));
            }
            else {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, global::System.Nullable<short> UnitsOnOrder, bool Discontinued, int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock, global::System.Nullable<short> Original_UnitsOnOrder, bool Original_Discontinued) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
            ...
            if ((UnitsOnOrder.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((short)(UnitsOnOrder.Value));
            }
            else {
            ...
            if ((Original_UnitsInStock.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((short)(Original_UnitsInStock.Value));
            }
            else {
            ...
            if ((Original_UnitsOnOrder.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((short)(Original_UnitsOnOrder.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[15].Value = ((bool)(Original_Discontinued));
