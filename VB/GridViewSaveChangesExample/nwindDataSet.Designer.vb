...
Namespace GridViewSaveChangesExample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal Discontinued As Boolean) As ProductsRow
				Dim rowProductsRow As ProductsRow = (CType(Me.NewRow(), ProductsRow))
				Dim columnValuesArray() As Object = { Nothing, ProductName, UnitPrice, UnitsInStock, UnitsOnOrder, Discontinued}
	...
	End Class
End Namespace
Namespace GridViewSaveChangesExample.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)) AND ((? = 1 AND `Discontinued` IS NULL) OR (`Discontinued` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`ProductName`, `UnitPrice`, `UnitsInStock`, `UnitsOnOrder" & "`, `Discontinued`) VALUES (?, ?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `UnitPrice` = ?, `UnitsInStock` = ?, `UnitsOnOrder` = ?, `Discontinued` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `UnitsOnOrder` IS NULL) OR (`UnitsOnOrder` = ?)) AND ((? = 1 AND `Discontinued` IS NULL) OR (`Discontinued` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, UnitPrice, UnitsInStock, UnitsOnOrder, Discontinue" & "d FROM Products"
		...
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsInStock As Global.System.Nullable(Of Short), ByVal Original_UnitsOnOrder As Global.System.Nullable(Of Short), ByVal Original_Discontinued As Boolean) As Integer
			...
			If (Original_UnitPrice.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(4).Value = (CDec(Original_UnitPrice.Value))
			Else
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CShort(Fix(Original_UnitsInStock.Value)))
			Else
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CShort(Fix(Original_UnitsOnOrder.Value)))
			Else
				Me.Adapter.DeleteCommand.Parameters(7).Value = (CObj(1))
				Me.Adapter.DeleteCommand.Parameters(8).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.DeleteCommand.Parameters(9).Value = (CObj(0))
			Me.Adapter.DeleteCommand.Parameters(10).Value = (CBool(Original_Discontinued))
		...
		Public Overridable Function Insert(ByVal ProductName As String, ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsInStock As Global.System.Nullable(Of Short), ByVal UnitsOnOrder As Global.System.Nullable(Of Short), ByVal Discontinued As Boolean) As Integer
			...
			If (UnitPrice.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(1).Value = (CDec(UnitPrice.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			If (UnitsInStock.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(2).Value = (CShort(Fix(UnitsInStock.Value)))
			Else
				Me.Adapter.InsertCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			If (UnitsOnOrder.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(3).Value = (CShort(Fix(UnitsOnOrder.Value)))
			Else
				Me.Adapter.InsertCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.InsertCommand.Parameters(4).Value = (CBool(Discontinued))
		...
		Public Overridable Function Update(ByVal ProductName As String, ByVal UnitPrice As Global.System.Nullable(Of Decimal), ByVal UnitsInStock As Global.System.Nullable(Of Short), ByVal UnitsOnOrder As Global.System.Nullable(Of Short), ByVal Discontinued As Boolean, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_UnitPrice As Global.System.Nullable(Of Decimal), ByVal Original_UnitsInStock As Global.System.Nullable(Of Short), ByVal Original_UnitsOnOrder As Global.System.Nullable(Of Short), ByVal Original_Discontinued As Boolean) As Integer
			If (ProductName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("ProductName")
			Else
			...
			End If
			If (UnitPrice.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CDec(UnitPrice.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			If (UnitsInStock.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(2).Value = (CShort(Fix(UnitsInStock.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			If (UnitsOnOrder.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CShort(Fix(UnitsOnOrder.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(3).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(4).Value = (CBool(Discontinued))
			...
			If (Original_UnitPrice.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CDec(Original_UnitPrice.Value))
			Else
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CShort(Fix(Original_UnitsInStock.Value)))
			Else
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CShort(Fix(Original_UnitsOnOrder.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CObj(1))
				Me.Adapter.UpdateCommand.Parameters(13).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(14).Value = (CObj(0))
			Me.Adapter.UpdateCommand.Parameters(15).Value = (CBool(Original_Discontinued))
